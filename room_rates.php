...
if($days <= 0){
  $msg = 'Habitación disponible hoy';
}else{
   $msg =  'Habitación disponible desde:'.$_POST['arrival']. ' a: ' .$_POST['departure'];
                 ...
                 <div class="form-group">
                        <div class="row">
                          <div class="col-xs-12 col-sm-12">
                            <input type="submit" class="button rooms_button"  id="booknow" name="booknow" onclick="return validateBook();" value="Reserva ahora!"/>
                ...
                ?>
                 ...
                 <input type="hidden" name="ROOMPRICE" value="<?php echo $result->PRICE ;?>">
                  <input type="hidden" name="ROOMID" value="<?php echo $result->ROOMID ;?>">
                      ...
                      <div class="card">
                        <img class="card-img-top"  src="<?php echo WEB_ROOT .'admin/mod_room/'.$result->ROOMIMAGE; ?>" alt="Descripción de la imagen de la habitación">
                        <div class="card-body">
                          ...
                          <div class="rooms_list">
                            <ul>
                              <li class="d-flex flex-row align-items-center justify-content-start">
                                ...
                                <span>Numero de personas - <?php echo $result->NUMPERSON ;?></span>
                              </li> 
                              <li class="d-flex flex-row align-items-center justify-content-start">
                                <img src="images/check.png" alt="">
                                <span>Habitaciones restantes :<?php echo  $resNum ;?></span>
                              </li>
                            </ul>
                          </div>
                          <div class="rooms_price"><?php echo   $result->PRICE ;?>/<span>Noche</span></div>
                           <?php echo $btn ; ?> 
                        </div>
                      </div>
