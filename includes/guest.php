...
class Guest{
	...
	public function create() {
		global $mydb;
		// No olvide su sintaxis SQL y sus buenos hábitos:
		// - INSERT INTO table (key, key) VALUES ('value', 'value')
		// - comillas simples alrededor de todos los valores
		// - escapar de todos los valores para evitar la inyección de SQL
