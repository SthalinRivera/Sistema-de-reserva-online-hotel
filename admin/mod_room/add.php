...
<div class="card card-primary">
            ...
            <div class="col-md-8">
              ...
              <div class="col-md-8">
                 ...
                 <input class="form-control input-sm" id="ROOM" name="ROOM" placeholder=
									  "Nombre de habitacion" type="text" value="">
              </div>
            </div>
          </div>
          ...
          <div class="form-group">
            <div class="col-md-8">
              <label class="col-md-4 control-label" for=
              "NUMPERSON">Numero de persona:</label>

              <div class="col-md-8">
                <input class="form-control input-sm" id="NUMPERSON" name="NUMPERSON" placeholder=
                    "Numero de persona" type="text" value="1" onkeyup="javascript:checkNumber(this);">
              </div>
            </div>
          </div>
            ...
            <div class="col-md-8">
              ...
              <div class="col-md-8"> 
                <input class="form-control input-sm" id="PRICE" name="PRICE" placeholder=
									  "Precio" type="text" value="" onkeyup="javascript:checkNumber(this);">
              </div>
            </div>
          </div>
