	...
	<div class="panel ">
		...
		<h4>Status :: </h4>
		  ...
		  <select name="categ" class="form-control">
		  	...
		  	<option value="Arrival" <?php echo isset($_POST['categ']) && $_POST['categ'] == 'Arrival' ? 'selected' :'' ?>>LLegada</option>
		  	<option value="Pending" <?php echo isset($_POST['categ']) && $_POST['categ'] == 'Pending' ? 'selected' :'' ?>>Pendiente</option>
		  	<option value="Confirmed" <?php echo isset($_POST['categ']) && $_POST['categ'] == 'Confirmed' ? 'selected' :'' ?>>Confirmado</option>
		  </select>
		  </div>
		 <div class="form-group">
		<h4>Date Filter :: </h4>
