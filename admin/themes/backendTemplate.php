    ...
    <div class="wrapper">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link" data-toggle="dropdown" href="#">
                        ...
                        <span class="badge badge-warning navbar-badge"><?php echo  isset($result->Total) ?  $result->Total : '';?></span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <span class="dropdown-item dropdown-header"><?php echo  isset($result->Total) ?  $result->Total : '';?> Notifications</span>
                        <div class="dropdown-divider"></div>
                        <a href="#" class="dropdown-item">
                            <i class="fas fa-envelope mr-2"></i> <?php echo  isset($result->Total) ?  $result->Total : '';?> Por  cofirmar
                            <span class="float-right text-muted text-sm"></span>
                        </a>
                        <div class="dropdown-divider"></div>
                        <a href="<?php echo WEB_ROOT; ?>admin/mod_reservation/index.php" class="dropdown-item dropdown-footer">Ver todas las notificaciones</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link" data-toggle="dropdown" href="#">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <div class="card-body box-profile">
                            <div class="text-center">
                                <img class="profile-user-img img-fluid img-circle" src="<?php echo WEB_ROOT; ?>admin/adminLTE/dist/img/user4-128x128.jpg" alt="User profile picture">
                            </div> 
                            <h3 class="profile-username text-center"> <?php echo $_SESSION['ADMIN_UNAME'];?></h3>
                        </div>
						<div class="dropdown-divider"></div>
						<span class="dropdown-item dropdown-header">
                           <a class="<?php echo (currentpage() == 'logout.php') ? "active" : false;?>  toggle-modal" href="#logout" class="dropdown-item dropdown-footer"><p><i class="far fa-user"></i>  Cerrar Sesion</p></a>
                        </span>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="" class="brand-link">
                <img src="<?php echo WEB_ROOT; ?>admin/adminLTE/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="<?php echo WEB_ROOT; ?>admin/adminLTE/dist/img/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    ...
                                    <a href="<?php echo WEB_ROOT; ?>admin/mod_accomodation/index.php?view=add" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item has-treeview">
							...
							<i class="far fa-calendar-check"></i>
                                <p>
                                    Reserva
									<i class="fas fa-angle-left right"></i>
									<span class="badge badge-info right"> <?php echo  isset($result->Total) ?  $result->Total : '';?> </span>
                                </p>
							</a>
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo WEB_ROOT; ?>admin/mod_booking/index.php?view=search" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
										<p>Agregar reserva</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo WEB_ROOT; ?>admin/mod_users/index.php?view=add" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo WEB_ROOT; ?>admin/index.php">Inicio</a></li>
