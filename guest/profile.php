...
?>
    ...
    <section class="content-header">
      <h1>
      Mi cuenta
        <small>detalles de la cuenta</small>
      </h1> 
    </section>
    ...
    <br/>
              ...
              <div class="table-responsive mailbox-messages">
                ...
                <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <div class="col-md-10">
                        <label class="col-md-4 control-label" for=
                        "dbirth">FECHA DE CUMPLEAÑOS:</label>
            ...
            <div class="box-footer no-padding"> 
                <div class="pull-right"> 
                  <div class="btn-group">
                   <input name="submit" type="submit" value="Guardar"  class="btn btn-primary" onclick="return personalInfo();"/>
                     </div>
                  <!-- /.btn-group -->
                </div>
                <!-- /.pull-right -->
...
$('.dbirth').datetimepicker({
  ...
  //Validates Personal Info
        ...
        {
        alert ('Acerptar  los términos y condiciones de este hotel');
        return false;
        }
