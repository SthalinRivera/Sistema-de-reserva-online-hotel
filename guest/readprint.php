    ...
    <section class="invoice">
      ...
      <div class="row invoice-info">
        <div class="col-sm-4 invoice-col">
          ...
          <address>
            <strong> </strong><br>
            Las Palmas, Distrito de San Vicente<br>
            Larco Herrera 15701<br>
            Phone: +51999583745<br>
            Email: hola@Hospedajepacifico.com
          </address>
        </div>
        <!-- /.col -->
        <div class="col-sm-4 invoice-col">
        ...
        <br/>
          ...
          <br> -->
          <b>ID de confirmación:</b> <p style="background-color:blue;color:white"> <?php echo $res->CONFIRMATIONCODE; ?></p> 
          <input type="hidden" name="code" value="<?php echo $res->CONFIRMATIONCODE; ?>">
<br>
          <b>Fecha de Transacción:</b> <?php echo  Date($res->TRANSDATE); ?>
<br>
          <b>Cuenta:</b> <?php echo $res->GUESTID; ?>
        ...
        <div class="col-xs-12 table-responsive">
          ...
          $days =  dateDiff(date($result->ARRIVAL),date($result->DEPARTURE));
            ...
            <tr> 
              ...
              <td> S/. <?php echo $result->RPRICE;?></td>
            </tr>
