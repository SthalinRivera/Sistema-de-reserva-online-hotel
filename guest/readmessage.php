    ...
    <section class="invoice">
      ...
      <div class="row invoice-info">
        ...
        <br/>
          ...
          <br> -->
          <b>ID de confirmación: </b> <p style="background-color:blue;color:white"> <?php echo $result->CONFIRMATIONCODE; ?></p> 
          <input type="hidden" name="code" value="<?php echo $result->CONFIRMATIONCODE; ?>">
<br>
          <b>Fecha de Transacción:</b> <?php echo  Date($result->TRANSDATE); ?>
<br>
          <b>Cuenta:</b> <?php echo $result->GUESTID; ?>
