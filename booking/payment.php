...
<script type="text/javascript"> alert("La reserva se envió correctamente!");</script>
...
<div id="bread">
   <ol class="breadcrumb">
      ...
      <li><a href="<?php echo WEB_ROOT ;?>booking/">Carrito de reserva</a></li>  
       <li class="active">Detalles de la reserva</li>
   </ol> 
</div> 
   ...
   echo $count_cart;
    ...
    <div class="col-md-4 col-sm-2">
      <div class="col-md-12">
       ...
       <div class="col-md-12">
        <label>Codio de Transacción:</label>
...
?>
        ...
        <tr>
          ...
          <td><?php echo ' S/.'.   $_SESSION['dragonhouse_cart'][$i]['dragonhouseroomprice']; ?></td>
        </tr>
<?php
 ...
 ?> 
    ...
    <div class="right"> 
      <h3 style="text-align: right;">Total: S/. <?php echo   $_SESSION['pay'] ;?></h3>
    </div>
    <br>
    <div class="">
       <button type="submit" class="button"  name="btnsubmitbooking">Enviar reserva</button>
    </div>
  </div>   
</form>
